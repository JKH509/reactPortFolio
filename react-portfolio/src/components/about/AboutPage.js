...
<div className="container mb-5 pr-5 pl-5">
<section className="mt-5 row cards border border-white">
    ...
    <div className="col-12 col-lg-8">
        ...
        <p style={{textAlign:"left"}}>I am almost 39 years old, I have 3 kids, 2 which are teenagers that will soon graduate high school, and start their
...
<section className="row mt-2">
    <div className="col-12 col-lg-6 border border-white cards mt-2" style={{height: "450px", overflow: "auto", scrollBehavior: "auto " }}>
        <h2 className="mt-2">Why coding?</h2>
        <p className="pr-2 pl-2" style={{textAlign:"left"}}>It's hard to explain, it wasn't my dream job for many years. In fact, before I started going to college I had
        ...
        <p className="pr-2 pl-2" style={{textAlign:"left"}}>
        ...
        <p className="pr-2 pl-2" style={{textAlign:"left"}}>Apparently thats when fate stepped in. I broke my neck in a car accident and that was the slow decline of my business
...
<section className="row mt-2">
    ...
    <div className="col-12 col-lg-6 p-3 border border-white cards mt-2" style={{height: "450px", overflow: "hidden", scrollBehavior: "auto " }}>
        ...
        <p className="" style={{textAlign:"left"}}>Back when I was still trying to grow my landscape business I knew the importance of 
